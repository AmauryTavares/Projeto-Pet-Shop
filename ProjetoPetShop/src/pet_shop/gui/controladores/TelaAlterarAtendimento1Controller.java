...
public class TelaAlterarAtendimento1Controller implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		try {
			atualizarTabela(fachada.listarTodosAnimais());
			tbViewAnimais.getSelectionModel().select(TelaGenAtendimentosController.atendimentoAlterar.getAnimal());
		} catch (NadaEncontradoException e) {
			funcoes.alerta(AlertType.ERROR, "Ocorreu um problema!", "", e.getMessage());
		}
